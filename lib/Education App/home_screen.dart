             ...
             children: [
               ...
               const Padding(padding: EdgeInsets.only(left: 3,bottom: 15),
                 child:Text("Hi Programmer",
                   style: TextStyle(fontSize: 25,fontWeight: FontWeight.w600,letterSpacing: 1,wordSpacing: 2,
                   color: Colors.white),) ,
           ...
           child: Column(
             children: [
                 ...
                 itemBuilder: (context,index){
                   return Column(
                     children: [
                       ...
                       Text(catNames[index],style: TextStyle(fontSize: 16,
               ...
               Row(
                 mainAxisAlignment: MainAxisAlignment.spaceBetween,
                 children: const [
                   Text('Courses',style: TextStyle(fontSize: 23,
                       fontWeight: FontWeight.w600),),
                   Text('See All',style: TextStyle(fontSize: 18,
                       fontWeight: FontWeight.w500,color: Color(0xFF674AEF)),)
                       ...
                       child: Column(
                         children: [
                           Padding(padding: const EdgeInsets.all(10),
                             child: Image.asset(
                               'images/edupic/${imgList[index]}.png',
                               height: 100,
                               width: 100,
                             ),
                           ),
